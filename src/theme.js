...
export const advancedDarkTheme = {
  body: "#121212",             // True dark background
  text: "#E0E0E0",             // High-contrast light text
  expTxtColor: "#FFFFFF",      // Brighter for important text like experience/headers
  highlight: "#BB86FC",        // Subtle purple highlight (Material Design style)
  dark: "#0A0A0A",             // Deep dark fallback/shadow
  secondaryText: "#B0B0B0",    // Muted secondary text
  imageHighlight: "#03DAC6",   // Teal-accented image border/highlight
  compImgHighlight: "#2C2C2C", // Subtle highlight for component images
  jacketColor: "#3700B3",      // Deep purple (used for accents or clothing in illustrations)
  headerColor: "#BB86FC77",    // Semi-transparent purple for header overlays
  splashBg: "#1F1B24",         // Slightly tinted dark splash background
};
